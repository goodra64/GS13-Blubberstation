...
/datum/outfit/persistence/prisoner/feedee
	...
	uniform = /obj/item/clothing/under/dual_tone/security/red/syndieprisoner

/obj/item/clothing/under/dual_tone/security/red/syndieprisoner
	name = "modular syndicate prisoner jumpsuit"
