...
#define TOTAL_LAYERS 52 // SKYRAT EDIT CHANGE - ORIGINAL: 38 GS EDIT ORIGINAL: 45
/// Mutations layer - Tk headglows, cold resistance glow, etc
#define MUTATIONS_LAYER 51 // SKYRAT EDIT CHANGE - ORIGINAL: 37 // GS13 EDIT original: 44
#define BREASTS_BEHIND_LAYER	50		//GS13 Edit - Modular Clothes Layer
/// Mutantrace features (tail when looking south) that must appear behind the body parts
#define BODY_BEHIND_LAYER 49 // SKYRAT EDIT CHANGE - ORIGINAL: 36 // GS13 EDIT original: 43
/// Layer for bodyparts that should appear behind every other bodypart - Mostly, legs when facing WEST or EAST
#define BODYPARTS_LOW_LAYER 48 // SKYRAT EDIT CHANGE - ORIGINAL: 35 // GS13 EDIT original: 42
/// Layer for most bodyparts, appears above BODYPARTS_LOW_LAYER and below BODYPARTS_HIGH_LAYER
#define BODYPARTS_LAYER 47 // SKYRAT EDIT CHANGE - ORIGINAL: 34 // GS13 EDIT original: 41
/// Mutantrace features (snout, body markings) that must appear above the body parts
#define BODY_ADJ_LAYER 46 // SKYRAT EDIT CHANGE - ORIGINAL: 33 // GS13 EDIT original: 40
/// Underwear, undershirts, socks
#define BODY_LAYER 45 // SKYRAT EDIT CHANGE - ORIGINAL: 32 // GS13 EDIT original: 39
/// Eyes and eyelids
#define EYES_LAYER 44 // SKYRAT EDIT CHANGE - ORIGINAL: 31 // GS13 EDIT original: 38
/// Mutations that should appear above body, body_adj and bodyparts layer (e.g. laser eyes)
#define FRONT_MUTATIONS_LAYER 43 // SKYRAT EDIT CHANGE - ORIGINAL: 30 // GS13 EDIT original: 37
/// Damage indicators (cuts and burns)
#define DAMAGE_LAYER 42 // SKYRAT EDIT CHANGE - ORIGINAL: 29 // GS13 EDIT original: 36
// SKYRAT EDIT ADDITION START
/// This layer is used for things that shouldn't be over clothes, but should be over mutations
#define BODY_FRONT_UNDER_CLOTHES 41 // GS13 EDIT original: 35
// SKYRAT EDIT ADDITION END
/// Jumpsuit clothing layer
#define UNIFORM_LAYER 40 // SKYRAT EDIT CHANGE - ORIGINAL: 27  // GS13 EDIT original: 34
...
//SKYRAT EDIT ADDITION END
/// ID card layer
#define ID_LAYER 34 // GS13 EDIT original: 28
/// ID card layer (might be deprecated)
#define ID_CARD_LAYER 33 // GS13 EDIT original: 27
/// Layer for bodyparts that should appear above every other bodypart - Currently only used for hands
#define BODYPARTS_HIGH_LAYER 32 // GS13 EDIT original: 26
/// Gloves layer
#define GLOVES_LAYER 31 // GS13 EDIT original: 25
/// Shoes layer
#define SHOES_LAYER 30 // GS13 EDIT original: 24
/// Layer for masks that are worn below ears and eyes (like Balaclavas) (layers below hair, use flagsinv=HIDEHAIR as needed)
#define LOW_FACEMASK_LAYER 29 // GS13 EDIT original: 23
...
/// Glasses layer
#define GLASSES_LAYER 22	// GS13, original: 19
/// Belt layer
#define BELT_LAYER 21	// GS13, original: 18 //Possible make this an overlay of something required to wear a belt?
/// Suit storage layer (tucking a gun or baton underneath your armor)
#define SUIT_STORE_LAYER 20	// GS13, original: 17
/// Neck layer (for wearing capes and bedsheets)
#define NECK_LAYER 19	// GS13, original: 16
/// Back layer (for backpacks and equipment on your back)
#define BACK_LAYER 18	// GS13, original: 15

#define BELLY_FRONT_LAYER		17		//GS13 Edit - Modular Clothes Layer
#define BREASTS_FRONT_LAYER		16		//GS13 Edit - Modular Clothes Layer
#define BUTT_BEHIND_LAYER		15		//GS13 Edit - Modular Clothes Layer
